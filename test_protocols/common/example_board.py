...
class SE40RoutingStructure(RoutingStructure):
    ...
    def __init__(self):
        ...
        super().__init__(
            layers={0: outer_layer, 1: mid_layer, 2: mid_layer, -3: mid_layer, -2: mid_layer, -1: outer_layer},
            impedance=40.0,
        )
...
class ExampleBoard(Board):
    ...
    vias = [ExampleSubstrate.MicroViaTop1, ExampleSubstrate.MicroViaTop2, ExampleSubstrate.MicroViaTop3, ExampleSubstrate.MicroViaTop4, ExampleSubstrate.DefaultTHVia]
