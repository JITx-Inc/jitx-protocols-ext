...
class SFPLink(Enum):
    ...
    SFP = SFPStandard(1, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "1.0 Gbit/s - 1 lane"

    CSFP = SFPStandard(2, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "1.0 Gbit/s - 2 lanes (cSFP)"

    SFP_PLUS = SFPStandard(1, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "10.0 Gbit/s - 1 lane (SFP+)"

    SFP28 = SFPStandard(1, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "25.0 Gbit/s - 1 lane"

    SFP56 = SFPStandard(1, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "50.0 Gbit/s - 1 lane"

    SFP_DD = SFPStandard(2, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "100.0 Gbit/s - 2 lanes (SFP-DD)"

    SFP112 = SFPStandard(1, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "100.0 Gbit/s - 1 lane"

    SFP_DD112 = SFPStandard(2, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "200.0 Gbit/s - 2 lanes (SFP-DD112)"

    QSFP = SFPStandard(4, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "4.0 Gbit/s - 4 lanes"

    QSFP_PLUS = SFPStandard(4, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "40.0 Gbit/s - 4 lanes (QSFP+)"

    QSFP28 = SFPStandard(4, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "100.0 Gbit/s - 4 lanes"

    QSFP56 = SFPStandard(4, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "200.0 Gbit/s - 4 lanes"

    QSFP112 = SFPStandard(4, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
    "400.0 Gbit/s - 4 lanes"

    QSFP_DD = SFPStandard(8, Toleranced(0, 1.0e-12), Toleranced(0, 100.0e-12), 5.0, Toleranced.percent(100, 10))
