...
def width_to_lane_count(width: DDR4Width) -> int:
    ...
    elif width == DDR4Width.x8:
        return 1
    elif width == DDR4Width.x16:
        return 2
    elif width == DDR4Width.x24:
        return 3
    elif width == DDR4Width.x32:
        return 4
    elif width == DDR4Width.x36:
        return 5  # 4 data + 1 ECC nibble
    elif width == DDR4Width.x40:
        return 5
    elif width == DDR4Width.x64:
        return 8
    elif width == DDR4Width.x72:
...
class DDR4Constraint(SignalConstraint["DDR4"]):
    ...
    def __init__(
        ...
        self.data_constraint = data_constraint if data_constraint is not None else DDR4DataConstraint()
        self.acc_constraint = acc_constraint if acc_constraint is not None else DDR4AccConstraint()
